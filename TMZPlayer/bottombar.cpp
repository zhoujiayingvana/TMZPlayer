...
{
    connect(settingWindow,SIGNAL(sigActionShortcut(QString)),
            this,SLOT(changeActionShortcut(QString)));//换暂停播放快捷键
    connect(settingWindow,SIGNAL(sigLastShortcut(QString)),
            this,SLOT(changeLastShortcut(QString)));//换上一首快捷键
    connect(settingWindow,SIGNAL(sigNextShortcut(QString)),
            this,SLOT(changeNextShortcut(QString)));//换下一首快捷键
    connect(settingWindow,SIGNAL(sigLouderShortcut(QString)),
            this,SLOT(changeLouderShortcut(QString)));//换音量增快捷键
    connect(settingWindow,SIGNAL(sigLowerShortcut(QString)),
            this,SLOT(changeLowerShortcut(QString)));//换音量减快捷键
}
...
{
    //pauseButton->setShortcut(QKeySequence(QLatin1String(str)));
}
...
/**
* @method        BottomBar::changeLouderShortcut
* @brief         音量增快捷键修改
* @author        涂晴昊
* @date          2019-08-29
*/
void BottomBar::changeLouderShortcut(QString str)
{

}

/**
* @method        BottomBar::changeLowerShortcut
* @brief         音量减快捷键修改
* @author        涂晴昊
* @date          2019-08-29
*/
void BottomBar::changeLowerShortcut(QString str)
{
